*begin "version 2021.1.0.28  8-1-2023  22:16:23"
...
*quit 1 "8-1-2023  22:16:32"


# Session ended at "8-1-2023  22:16:33"
return; # Stop script and return to application 
# *quit 1; # Uncomment to exit application
*begin "version 2021.1.0.28  7-5-2024  21:01:30"
*createstringarray 17 " 0 penalty value              0.00    0.00    0.80    1.00   10.00" \
  "  1 min length        1 1.0  10.000   9.000   4.000   2.000   1.000    1   59    0" \
  "  2 max length        1 1.0  10.000  12.000  15.000  20.000  30.000    0   39    1" \
  "  3 aspect ratio      1 1.0   1.000   2.000   4.400   5.000  10.000    0   41    2" \
...
*loaddefaultattributevaluesfromxml 
*settopologydisplaymode 0
*quit 1 "7-5-2024  21:01:50"


# Session ended at "7-5-2024  21:01:50"
return; # Stop script and return to application 
# *quit 1; # Uncomment to exit application
*begin "version 2021.1.0.28  7-8-2024  21:20:09"
*createstringarray 17 " 0 penalty value              0.00    0.00    0.80    1.00   10.00" \
  "  1 min length        1 1.0  10.000   9.000   4.000   2.000   1.000    1   59    0" \
  "  2 max length        1 1.0  10.000  12.000  15.000  20.000  30.000    0   39    1" \
  "  3 aspect ratio      1 1.0   1.000   2.000   4.400   5.000  10.000    0   41    2" \
...
*loaddefaultattributevaluesfromxml 
*settopologydisplaymode 0
*quit 1 "7-8-2024  21:20:15"


# Session ended at "7-8-2024  21:20:15"
return; # Stop script and return to application 
# *quit 1; # Uncomment to exit application
*begin "version 2021.1.0.28  7-8-2024  21:21:19"
*createstringarray 17 " 0 penalty value              0.00    0.00    0.80    1.00   10.00" \
  "  1 min length        1 1.0  10.000   9.000   4.000   2.000   1.000    1   59    0" \
  "  2 max length        1 1.0  10.000  12.000  15.000  20.000  30.000    0   39    1" \
  "  3 aspect ratio      1 1.0   1.000   2.000   4.400   5.000  10.000    0   41    2" \
...
*loaddefaultattributevaluesfromxml 
*settopologydisplaymode 0
*quit 1 "7-8-2024  21:21:25"


# Session ended at "7-8-2024  21:21:25"
return; # Stop script and return to application 
# *quit 1; # Uncomment to exit application
*begin "version 2021.1.0.28  7-8-2024  23:52:33"
*createstringarray 17 " 0 penalty value              0.00    0.00    0.80    1.00   10.00" \
  "  1 min length        1 1.0  10.000   9.000   4.000   2.000   1.000    1   59    0" \
  "  2 max length        1 1.0  10.000  12.000  15.000  20.000  30.000    0   39    1" \
  "  3 aspect ratio      1 1.0   1.000   2.000   4.400   5.000  10.000    0   41    2" \
...
*loaddefaultattributevaluesfromxml 
*settopologydisplaymode 0
*quit 1 "7-8-2024  23:52:39"


# Session ended at "7-8-2024  23:52:40"
return; # Stop script and return to application 
# *quit 1; # Uncomment to exit application
