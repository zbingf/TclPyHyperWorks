...
class pointJudge:
    ...
    def __init__(self, inputData):
        ...
        # self.locDictMin = {}
        # self.locDictMax = {}
        # self.locDictMinSecond = {}
        # self.o1, self.o2, self.o3, self.o4 = [], [], [], []
        # self.o5, self.o6, self.o7, self.o8 = [], [], [], []
    ...
    def dataCal(self, inputData):
        ...
        list_input = [float(value) for value in inputData.split(' ') if value]

        lenList1 = len(list_input)
        x_locs, y_locs, z_locs = [n for n in range(0, lenList1, 3)] \
                            ,[n for n in range(1, lenList1, 3)]  \
                            ,[n for n in range(2, lenList1, 3)] 
                            
        arr1 = numpy.array(list_input)
        arrX, arrY, arrZ = arr1[x_locs], arr1[y_locs], arr1[z_locs]
        arrLoc = [arrX, arrY, arrZ]
        maxF, minF, minSecondList = [], [], []
        locDictMin, locDictMax, locDictMinSecond = {}, {}, {}
...
def isRectangularBox(inputData, is_test=False):
    # 矩形钢判定
    if is_test:
...
# print(isRectangularBox(test, is_test=True))
