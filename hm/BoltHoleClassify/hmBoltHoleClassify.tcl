...
if {[info exists ::BoltHoleClassify::angle_limit]==0} {set ::BoltHoleClassify::angle_limit 3}
...
proc ::BoltHoleClassify::GUI { args } {
    ...
    entry $recess.entry1 -width 16 -textvariable ::BoltHoleClassify::angle_limit -font {MS 10}
    grid $recess.entry1 -row 6 -column 1 -padx 2 -pady 2 -sticky nw;

    ::hwt::RemoveDefaultButtonBinding $recess;
    ::hwt::PostWindow winBoltHoleCorrect -onDeleteWindow ::BoltHoleClassify::Quit;
}
...
proc ::BoltHoleClassify::OkExit { args } {
    ...
    set angle_limit     $::BoltHoleClassify::angle_limit
