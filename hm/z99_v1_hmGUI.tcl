...
# 2层-2列
button .f.top.2.1 -text "矩形钢" -command [format "source %s/RectangularBox/hmRectangularBox.tcl" $filepath] -bg #99ff99 -width 10
...
# # 2层-5列
button .f.top.5.1 -text "模态叠加相关UI" -command [format "source %s/TransientLoad/hmGUI.tcl" $filepath] -bg #99ff99 -width 10
pack .f.top.5.1 -side top -anchor nw -padx 5 -pady 1
